...
<template>
	...
	<div class="footer fstyle02 w-100">
		<table  width="100%" style="border: hidden;">
			<tr>
				<td width="33%" style="text-align: left;border: hidden;">文件編號：SICL-4-15-3</td>
				...
				<tr>
					<th colspan="3">
						<table width="100%" style="border: hidden;">
							...
							<tr>
								<td colspan="3" scope="col" class="fstyle02">
									<div>鏡頭畸變差糾正軟體 名稱：{{nowCaseDistSoft}}</div>
									<div>Lens distortion correction software</div>
								</td>
								<td class="fstyle02">
									<div>版本：{{nowCaseDistVer}}</div>
									<div>Version</div>
								</td>
							</tr>
						</table>
			...
			<tr>
				...
				<td colspan="3" class="fstyle03" style="line-height: 1.1;">
					<ol style="padding-left: 20px;">
						...
						<li>
							<div class="fbolder">顧客應自行完成空中三角平差解算，並繳交經鏡頭畸變差糾正後之影像及每張影像解算完成之內外方位參數資料。</div>
							<div>The customer should complete the aerotriangulation adjustment by himself, and submit the image corrected by the lens distortion and the internal and external orientation of each image solution.</div>
						</li>
						<li>
